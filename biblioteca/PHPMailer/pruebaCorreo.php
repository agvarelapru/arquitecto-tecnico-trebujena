<?php
  ...
  if(isset($_POST['btn_send']))
  {
   ...
   try
   {
    ...
    $mail->Username   ="agvarelayou@hotmail.com";  
                         $mail->Password   ="16del6del81";            
                        $mail->SetFrom('agvarelayou@hotmail.com','Programacion net');
                         $mail->AddReplyTo("agvarelayou@hotmail.com","Programacion net");
