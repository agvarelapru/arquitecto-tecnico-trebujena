...
while($reg5=mysqli_fetch_array($usuario)){
 ...
 ?>
    ...
    <br>
      ...
      <?php if($_SESSION["perfil"]=="Administrador") {
        ...
        <form  action="borrarU.php" method="post">
          ...
          <input  class="form-control" type="hidden" name="nick" id="nick" placeholder="Usuario" pattern="[.-_A-Za-z0-9 ñÑ]{1,50}"  title="Introduzca nombre de usuario .-_A-Za-z0-9 ñÑ" required autofocus value="<?php echo $reg['usuarios_usuario'];?>"/>
  ...
  <button  class="contact submit btn btn-primary btn-xl" style="float:left;" data-toggle="modal" data-target="#myModal"  type="button" formaction="borrarU.php" id="eliminar" name="eliminar"  value="Eliminar usuario"/>Eliminar usuario</button>
