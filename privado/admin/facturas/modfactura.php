...
$conexion=mysqli_connect(DBHOST,DBUSER,DBPASS,DBNAME) or die("Problemas con la conexión.");
  ...
  $consulta_mysql=mysqli_query($conexion,"select *  from facturas where facturas_id=".$_POST['facturas_id']) or
...
<h2 class="bottombrand wow flipInX">Modificar factura de <b style="color: #f05f40;"><?php echo " ".$_SESSION["usuario"]." "; ?></b></h2>
...
<br>
    <form method="post" action="?p=admin/facturas/facturamodificada" id="contactform">
  ...
  <div class="col-md-6">
        ...
        <br>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input  class="form-control"  type="text" name="numfac" id="umfac" placeholder="Numero factura" pattern="[0-9 /-.,]{1,10}"  title="Numero de la factura" value="<?php echo $reg["facturas_numero_factura"];?>"/>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input  class="form-control"   type="date" name="fecha" id="fecha" placeholder="Fecha factura"   title="Fecha de la factura" value="<?php echo $reg["facturas_fecha"];?>"/>
          </div>
...
die("Problemas en el select:".mysqli_error($conexion));
 ...
 ?>
            ...
            <label for="tipo">Descripcion del trabajo</label>
                <textarea class="form-control"  rows="4" placeholder="Tipo de trabajo" id="tipo" name="trabajos" pattern="[.-\/_()A-Za-z0-9 ñÑ'áéíóúüÁÉÍÓÚÜçÇàèìòùÀÈÌÒÙ]{5,500}" required ><?php echo $reg4["encargos_tipo"]." sito en ".$reg4["encargos_direccion"].", de ".$reg4["municipio"]." (".$reg4["provincia"].")";?></textarea>
              </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input  class="form-control" type="text" name="honorarios" id="honorarios" placeholder="Honorarios" pattern="[,.0-9]{1,6}"   title="Honorarios" required value="<?php echo $reg4["encargos_honorarios"];?>"/>
  ...
  <?php } ?>
                ...
                <div class="form-group">
                  ...
                  <input  class="form-control"   type="text" name="iva" id="iva" placeholder="IVA" pattern="[,.0-9]{1,10}"   title="IVA" required value="<?php echo $reg["facturas_iva"];?>"/>
                ...
                <div class="form-group">
                  ...
                  <input  class="form-control" type="text" name="irpf" id="irpf" placeholder="IRPF" pattern="[,.0-9]{1,10}"   title="IRPF" value="<?php echo $reg["facturas_irpf"];?>"/>
                ...
                <div class="form-group">
                  ...
                  <input  class="form-control" type="text" name="total" id="total" placeholder="TOTAL" pattern="[,.0-9]{1,10}"   title="TOTAL" required value="<?php echo $reg["facturas_total"];?>"/>
        ...
        <label for="observaciones">Observaciones</label>
          <textarea class="form-control"  rows="4" placeholder="observaciones" name="observaciones" pattern="[.-_A-Za-z0-9 ñÑ]{5,500}"><?php echo $reg["facturas_observaciones"];?></textarea>
        </div>
          </div>
          </div>
...
<button   class="contact submit btn btn-primary btn-xl"    data-toggle="modal" data-target="#myModal" type="button" id="modificar"  name="modificar"  value="Modificar "/>Modificar factura</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" >
        <p style="color:black;">¿Esta seguro de modificar la fcatura?</p>
