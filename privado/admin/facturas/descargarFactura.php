...
$conexion=mysqli_connect(DBHOST,DBUSER,DBPASS,DBNAME) or die("Problemas con la conexión.");
  ...
  $consulta_mysql2=mysqli_query($conexion,"select * from facturas where facturas_numero_factura='".$_GET["numfac"]."'") or
...
//$dompdf->stream();
$pdf = $dompdf->output();
file_put_contents('../../../documentos/facturas/factura2.pdf', $pdf);
